...
|---|---:|---:|---:|---:|---:|
| all comparisons | 1830 | -1.99 | -36.41 | 51% | -3.9% |
...
Brier score (lower is better) — model 0.2257 vs market 0.2034.

15 comparison(s) not yet settled and excluded rather than counted as losses.
