...
- filled and still open: 9
- expired unfilled (never hit — correctly NOT scored): 149
- unscored (closed before any open snapshot — capture gap): 4

**Verdict:** ❌ Mean CLV -2.6c over 135 bets — no edge vs the closing line. Do NOT put real money here.
