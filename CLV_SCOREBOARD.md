...
- **Scored samples:** 11 / 100
- **Mean CLV:** +1.5c per bet
- **Beat the close:** 64% of bets

### Settlement record (scored against Kalshi's official results)

- **7W – 2L** over 9 settled contracts
- **Net +60c** on 640c staked (**+9.4%**)
...
- resting (maker bid not yet hit): 77
...
**Verdict:** ⏳ 11 of 100 scored samples — not enough to read yet. No real money until this reaches 100+ and the mean is positive.
