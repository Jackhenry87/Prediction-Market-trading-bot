...
- **Scored samples:** 5 / 100
- **Mean CLV:** +4.2c per bet
- **Beat the close:** 80% of bets

### Settlement record (scored against Kalshi's official results)

- **4W – 1L** over 5 settled contracts
- **Net +58c** on 342c staked (**+17.0%**)
...
**Verdict:** ⏳ 5 of 100 scored samples — not enough to read yet. No real money until this reaches 100+ and the mean is positive.
