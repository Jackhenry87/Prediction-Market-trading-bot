...
- expired unfilled (never hit — correctly NOT scored): 98
- unscored (closed before any open snapshot — capture gap): 4

**Verdict:** ❌ Mean CLV -1.5c over 102 bets — no edge vs the closing line. Do NOT put real money here.
