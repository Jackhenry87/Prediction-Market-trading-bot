...
- **Scored samples:** 4 / 100
- **Mean CLV:** +21.8c per bet
- **Beat the close:** 100% of bets

### Settlement record (scored against Kalshi's official results)

- **4W – 0L** over 4 settled contracts
- **Net +125c** on 275c staked (**+45.5%**)
...
- resting (maker bid not yet hit): 71
- filled and still open: 16
- expired unfilled (never hit — correctly NOT scored): 1
- unscored (closed before any open snapshot — capture gap): 4

**Verdict:** ⏳ 4 of 100 scored samples — not enough to read yet. No real money until this reaches 100+ and the mean is positive.
