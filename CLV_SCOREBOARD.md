...
- filled and still open: 5
- expired unfilled (never hit — correctly NOT scored): 174
- unscored (closed before any open snapshot — capture gap): 4

**Verdict:** ❌ Mean CLV -2.1c over 144 bets — no edge vs the closing line. Do NOT put real money here.
