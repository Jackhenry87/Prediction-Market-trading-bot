...
- resting (maker bid not yet hit): 32
- filled and still open: 0
- expired unfilled (never hit — correctly NOT scored): 0
- unscored (closed before any open snapshot — capture gap): 4

**Verdict:** ⏳ 0 of 100 scored samples — not enough to read yet. No real money until this reaches 100+ and the mean is positive.
