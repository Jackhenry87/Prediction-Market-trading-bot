...
- resting (maker bid not yet hit): 54
- filled and still open: 21
- expired unfilled (never hit — correctly NOT scored): 123
- unscored (closed before any open snapshot — capture gap): 4

**Verdict:** ❌ Mean CLV -2.1c over 119 bets — no edge vs the closing line. Do NOT put real money here.
