...
- expired unfilled (never hit — correctly NOT scored): 97
- unscored (closed before any open snapshot — capture gap): 4

**Verdict:** ❌ Mean CLV -1.7c over 100 bets — no edge vs the closing line. Do NOT put real money here.
